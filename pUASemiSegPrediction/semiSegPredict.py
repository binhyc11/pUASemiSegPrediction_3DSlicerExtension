...
class semiSegPredictLogic(ScriptedLoadableModuleLogic):
    ...
    def __init__(self) -> None:
        ...
        self.PARAM_FILE_DIR = self.root.replace('semiSegPredict',"pyRadiomics_extraction_param.yaml")
    ...
    def processSeg(self,
        ...
        self.showSegmentation(f"The __{semiSegName}__ was a generated from __{imgName}__ and __{relSegName}__\
                \n\n\nNote: Check the result of the Semi-auto Segmentation algorithm\
                \n(Processing completed in {stopTimeSeg-startTimeSeg:.2f} seconds)\n\n\n\n")
    ...
    def processPred(self,
        ...
        self.showPrediction(f"Using CT images of __{volName}__ and Segmentation of __{segName}__, the model predicted this was a __{label}__ stone with the probability of __{prob}%__\
                            \n\nDisclaimer: Use at your own risk\
                            \n(Processing completed in {stopTimePred-startTimePred:.2f} seconds)\n\n\n\n")
